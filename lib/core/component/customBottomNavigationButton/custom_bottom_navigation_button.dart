...
class CustomBottomNavigationButton extends StatelessWidget {
    ...
    return Container(
      ...
      child: Stack(
        children: [
          // Sliding background
          AnimatedAlign(
            alignment: tabSwitchController.selectExpenseValue ? Alignment.centerLeft : Alignment.centerRight,
          ...
          Row(
            children: [
              _buildTab(
                context,
                AppLocalizations.of(context)!.bottomNavigationText1,
                tabSwitchController.selectExpenseValue,
                tabSwitchController.onTapExpense,
              ),
              _buildTab(
                context,
                AppLocalizations.of(context)!.bottomNavigationText2,
                !tabSwitchController.selectExpenseValue,
  ...
  Widget _buildTab(BuildContext context, String text, bool isSelected, VoidCallback onTap) {
    return Expanded(
        ...
        child: Center(
          child: AnimatedSwitcher(
            ...
            child: Text(
              ...
              style: GoogleFonts.saira(fontSize: 14, fontWeight: FontWeight.w600, color: isSelected ? Colors.black : Colors.grey[600]),
            ),
          ),
        ),
      ),
